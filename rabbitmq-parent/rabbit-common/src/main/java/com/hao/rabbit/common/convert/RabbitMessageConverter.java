...
//		messageProperties.setExpiration(delaultExprie);
        com.hao.rabbit.api.Message message = (com.hao.rabbit.api.Message) object;
    ...
    public Object fromMessage(Message message) throws MessageConversionException {
        com.hao.rabbit.api.Message msg = (com.hao.rabbit.api.Message) this.delegate.fromMessage(message);
        return msg;
    }
